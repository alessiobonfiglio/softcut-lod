...
class SoftGraphCut(nn.Module):
    def __init__(self, num_workers=8, multiprocess=False, multithread=False):
        super().__init__()
    ...
    def forward(self, pixel_scores, weights_col, weights_row):
        ...
        A = torch.sparse_coo_tensor(indices, values, (bs, pixel_scores_size[-2] * pixel_scores_size[-1], pixel_scores_size[-2] * pixel_scores_size[-1]))
