...
from softcut.SoftCut_exact_horses import SoftGraphCut
...
EXPERIMENT_NAME = "submodular_nips17_CNN+SoftCut_exact"
...
class CNNWithGC(pl.LightningModule):
    ...
    def forward(self, x):
        ...
        segmentation = self.gc(pixel_scores, weights_col, weights_row)
        return segmentation
